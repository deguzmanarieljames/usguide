              ...
              <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                  <div class="mb-3 mb-sm-0">
                    <h5 class="card-title fw-semibold">Events/Attendance</h5>
                  </div>
                  <div>
                    <select class="form-select">
                      ...
                      <option value="4">CCJE</option>
                      <option value="4">CAS</option>
                      <option value="4">BTVTED/LED</option>
                    </select>
                  </div>
                </div>
                <div id="chart"></div>
              ...
              <div class="col-lg-12">
                ...
                <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    <h5 class="card-title mb-9 fw-semibold">Funds</h5>
